...
class ApiKeysControllerTest < ActionController::TestCase
  ...
  test "should create api_key" do
    assert_difference('ApiKey.count') do
      post :create, api_key: { api_key: @api_key.api_key, mail: @api_key.mail, times_used: @api_key.times_used }
    end
  ...
  test "should update api_key" do
    patch :update, id: @api_key, api_key: { api_key: @api_key.api_key, mail: @api_key.mail, times_used: @api_key.times_used }
    assert_redirected_to api_key_path(assigns(:api_key))
  end
